...
const windowDetection = require('./modules/windowDetection');
const screenshotManager = require('./modules/screenshotManager');
const keyboardHandler = require('./modules/keyboardHandler');
const videoRecording = require('./modules/videoRecording');
